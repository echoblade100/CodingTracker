    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (input == "n")
                {
                    ...
                    string inputHabitName = UserInput.InputStringWithValidation();

                    Console.WriteLine("Habit measurement (example - trips per day):");
                    string inputHabitMeasurement = UserInput.InputStringWithValidation();
        ...
        public static void MainMenu()
        {
            ...
            while (!endApp)
            {
                ...
                int input = UserInput.InputNumberWithValidation();
        ...
        public static void InsertRecord()
        {
            ...
            DateTime date = UserInput.InputDataWithValidation(
                datePattern,
            ...
            int numberOfApproaches = UserInput.InputNumberWithValidation(0, int.MaxValue);
